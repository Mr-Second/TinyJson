...
namespace UT::json
    {
        ...
        Parser::Parser(Value &val, const std::string &content) : val_(val), cur_(content.c_str())
        {
            val_.set_type(json::type::Null);
            parse_whitespace();
            parse_value();
            parse_whitespace();
        ...
        void Parser::parse_value()
        {
            ...
            {
            case 'n':
                parse_literal("null", json::type::Null);
                return;
            case 't':
                parse_literal("true", json::type::True);
                return;
            case 'f':
                parse_literal("false", json::type::False);
                return;
            case '\"':
                parse_string();
                return;
